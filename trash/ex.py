...
from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QVBoxLayout, QWidget, QTabWidget, QToolBar, QAction, QTextEdit, QHBoxLayout, QScrollArea, QDialog, QLabel, QLineEdit
